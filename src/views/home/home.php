                ...
                <div class="col-lg-4 col-md-4 col-sm-6 mb-3 col-xs-12">
                    <div class="card card-oferta fade h-100">
                        <div class="p-3 text-center">
                            <img src="/img/products/<?php echo $oferta->getImage(); ?>" 
                                class="card-img-top" alt="<?php echo $oferta->getImage(); ?>" 
                                title="<?php echo $oferta->getImage();?>">
                        </div>
                        <div class="card-body">
                            ...
                            <a href="/detalhes-produto?id=<?php echo $oferta->getProductId(); ?>" 
