        ...
        <div class="card-body">
            <form action="/admin/vendedor/editar-post" method="post" id="form-cadastro" >
                ...
                <div class="row">
                    ...
                    value="<?php echo $model->getSellerId(); ?>" >
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="lastName" id="lastName" value="<?php echo $model->getLastName(); ?>" 
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="website" id="website" value="<?php echo $model->getWebsite(); ?>" 
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        value="<?php echo $model->getCompany(); ?>"    
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        value="<?php echo $model->getFantasyName(); ?>"    
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        value="<?php echo $model->getBranchOfActivity(); ?>"    
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        value="<?php echo $model->getStreet(); ?>"    
                                        data-required="true" aria-describedby="help-street">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        value="<?php echo $model->getNeighborhood(); ?>"   
                                          placeholder="" data-required="true" aria-describedby="help-neighborhood">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select data-required="true" class="form-control" name="stateId" id="stateId" 
                                            data-required="true" aria-describedby="stateId" placeholder="">
                                            <option value="">Selecione</option>
                                            <?php foreach($model->getStates() as $state ) : ?>
                                                <option value="<?php echo $state->getId(); ?>" 
                                                <?php echo (intval($state->getId()) == intval($model->getStateId()) ? " selected=selected " : ""); ?>>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="city" id="city" data-required="true" 
                                            value="<?php echo $model->getCity(); ?>" class="form-control" placeholder="" 
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="cep" id="cep" data-required="true"  
                                            value="<?php echo $model->getCep(); ?>" class="form-control" placeholder=""
                                             aria-describedby="help-cep">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" name="complement" id="complement" 
                                            ...
                                            aria-describedby="help-complement"><?php echo $model->getComplement(); ?></textarea>
