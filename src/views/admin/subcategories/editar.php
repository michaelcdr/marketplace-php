...
<div class="container">
    <div class="d-flex align-items-center p-3 mt-3 text-white-50 bg-dark rounded shadow-sm">
        <div class="lh-100">
            ...
            <ul class="nav-breadcrumb">
                <li>
                    <a href="/admin/subcategoria">Categorias</a>
                </li>
                <li>Editar</li>
            </ul>
        </div>
    ...
    <div class="card mt-3">
        <div class="card-body">
            <form action="/admin/subcategoria/editar-post" method="post" id="formCategories" data-img-path="<?php echo SrcHelper::getCategoryImg(); ?>">
